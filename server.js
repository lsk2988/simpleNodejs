...
var server = http.createServer(function(request, response){
  ...
  response.end()
	  ...
	  response.write('<!DOCTYPE html><html><head><link rel="stylesheet" href="/style"></head><body><h1>Hello Node.js</h1><script src="/script"></script></body></html>')
    response.end()	
  }else if(path =='/script'){
	  response.setHeader('Content-Type','text/javascript;charset=utf8')
	  response.write("alert('load page')")
          response.end()
  }else{
